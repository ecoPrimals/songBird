...
| Clippy Pedantic | All 31 crates clean (`clippy::pedantic + nursery`, zero warnings, `--all-targets --all-features`; June 21 2026 verified — Wave 121 fixed all `--all-targets` test lints) |
