...
| Clippy Pedantic | All 30 crates clean (`clippy::pedantic + nursery`, zero warnings, `--all-targets --all-features`; May 4 verified) |
| Build | Clean (zero errors, zero warnings) |
| Formatting | Clean (`cargo fmt --check`; May 4 verified) |
