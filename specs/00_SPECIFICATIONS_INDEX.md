...
- [ECOPRIMALS_ARCHITECTURE_CLARITY.md](./archived/ECOPRIMALS_ARCHITECTURE_CLARITY.md) — Architecture clarity *(archived: references never-created `songbird-client`)*
...
- [REMOTE_EXECUTION_API_SPEC.md](./archived/REMOTE_EXECUTION_API_SPEC.md) — Remote execution API *(archived: references non-existent module tree)*
