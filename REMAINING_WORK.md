...
| **Clippy Pedantic** | 30/30 crates clean — zero warnings (`clippy::pedantic + nursery`, `-D warnings`, May 5 verified) |
| **Format** | Clean (`cargo fmt --check` passes; May 5 verified) |
