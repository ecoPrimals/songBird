...
**Date**: May 19, 2026  
**Version**: v0.2.1  
**Last Deep Debt Audit**: Wave 210 (May 19, 2026)  
...
- [ ] Cross-gate integration test (2+ gates via songbird relay)
...
### Cross-Gate Dispatch (Phase 2 — Low Priority)

Multi-gate routing where biomeOS on gate A routes a `capability.call` to Songbird,
which relays it to Songbird on gate B, which dispatches locally. Structural
foundation exists (mesh networking, relay, TURN). Not blocking stadial entry.
