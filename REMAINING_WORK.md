...
**Date**: June 1, 2026  
**Version**: v0.2.2  
**Last Deep Debt Audit**: Wave 67/primalSpring (June 1, 2026) — P0 BLOCKER resolved: `songbird_http_client` security socket fix (`--security-socket` / `BEARDOG_SOCKET` honored; hardcoded `/tmp/neural-api-*.sock` eliminated). Full DH-1 compliance across all socket discovery chains. Previous: Wave 60 — 3 new mesh methods, data/cache/deploy paths DH-1 compliant  
