...
| **Files >800 lines** | 2 deferred (`bin_interface/server.rs` 878L, `turn_server.rs` 836L — tightly coupled, deferred Wave 200); largest non-deferred: `primal_discovery.rs` 763L; Wave 200: `method_gate.rs` (944L) → directory module; Wave 176: `information_layers.rs` (1121L) → directory module; Wave 133: 4 former >700L files refactored |
