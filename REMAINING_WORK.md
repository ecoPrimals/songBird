...
| Metric | Value |
|--------|-------|
| **Tests** | 7,319 lib passed, 0 failed, 22 ignored (env-dependent e2e/chaos/hardware/crypto-provider) |
...
**Remaining**: Storage capability provider must expose live `storage.*` IPC endpoints for end-to-end validation.
