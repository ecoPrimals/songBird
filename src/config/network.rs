...
impl NetworkConfig {
    ...
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            ...
            bind_address: env_config.bind_address.parse().map_err(|e| SongbirdError::Config { field: Some("bind_address".to_string()), message: format!("Invalid bind address: {}", e) })?,
            ...
            gaming_port_range: PortRange { start: env_config.gaming_port_range.0, end: env_config.gaming_port_range.1 },
    ...
    pub fn secure_defaults() -> Self {
        ...
        Self {
            ...
            discovery_port: 8001,
            health_port: 8002,
            gaming_port_range: PortRange { start: 7000, end: 7100 }, // Small safe range by default
            connection_limits: ConnectionLimits::default(),
            gaming: GamingNetworkConfig::default(),
            dashboard_port: 8080,
            timeouts: TimeoutConfig::default(),
    ...
    pub fn validate_production_readiness(&self) -> Result<()> {
        ...
        if self.bind_address.to_string() == "0.0.0.0" && std::env::var("SONGBIRD_PRODUCTION_BINDING_APPROVED").is_err() {
        ...
        if self.federation_endpoints.is_empty() && std::env::var("SONGBIRD_ENV").unwrap_or_default() == "production" {
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        let ports = [self.orchestrator_port,
            self.discovery_port,
            self.health_port,
            self.dashboard_port];
    ...
    pub fn for_gaming_scale(scale: crate::orchestrator::scaling::GamingScale) -> Self {
        use crate::orchestrator::scaling::GamingScale;
