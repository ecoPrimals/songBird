...
pub trait LifecycleHook: Send + Sync {
    ...
    async fn after_service_register(&self, service_id: &str, service_info: &ServiceInfo) -> Result<HookResult>;
    ...
    async fn before_request(&self, service_id: &str, request: &ServiceRequest) -> Result<HookResult>;
    
    /// After request processing
    async fn after_request(&self, service_id: &str, request: &ServiceRequest, response: &ServiceResponse) -> Result<HookResult>;
