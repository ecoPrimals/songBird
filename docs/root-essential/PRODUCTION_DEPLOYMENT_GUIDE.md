...
export STORAGE_PROVIDER_ENDPOINT="http://storage-service:8081"
export COMPUTE_PROVIDER_ENDPOINT="http://compute-service:8082"
export AI_PROVIDER_ENDPOINT="http://ai-service:8084"
...
curl http://storage-service:8081/health
curl http://compute-service:8082/health
```
