...
use songbird_orchestrator::{
    ...
    trust::{LineageAuthenticator, PeerAcceptanceDecision, LineageStatus},
};
...
async fn test_lineage_authenticator_different_lineage() -> Result<()> {
    ...
    match decision {
        PeerAcceptanceDecision::PromptUser { lineage_status, .. } => {
...
async fn test_lineage_authenticator_no_lineage() -> Result<()> {
    ...
    match decision {
        PeerAcceptanceDecision::PromptUser { lineage_status: LineageStatus::UnknownLineage, .. } => {
...
async fn test_lineage_authenticator_invalid_proof() -> Result<()> {
    ...
    match decision {
        PeerAcceptanceDecision::Reject { reason } => {
