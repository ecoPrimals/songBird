...
impl Default for EnvironmentConfig { fn default() -> Self { Self { environment: Environment::Development,
...
impl Default for PortConfig { fn default() -> Self { Self { orchestrator_port: 8080,
            discovery_port: 8081,
...
impl Default for LoggingConfig { fn default() -> Self { Self { level: "info".to_string(),
...
impl Default for ObservabilityConfig { fn default() -> Self { Self { enable_metrics: true,
            metrics_interval: 60,
            enable_tracing: true,
...
impl Default for NetworkConfig { fn default() -> Self { Self { bind_address: "0.0.0.0".to_string(),
            enable_tls: false,
            tls_cert_path: None,
    tls_key_path: None,
...
impl Default for EnvironmentSecurityConfig { fn default() -> Self { Self { enable_auth: true,
