...
mod tests {
    ...
    fn test_scaling_decision_scale_up() {
        ...
        let decision = scaler
            .evaluate_scaling("test-service", 2, &high_usage, 100.0)
            .expect("Scaling evaluation should succeed in tests");
    ...
    fn test_scaling_decision_scale_down() {
        ...
        let decision = scaler
            .evaluate_scaling("test-service", 2, &low_usage, 100.0)
            .expect("Scaling evaluation should succeed in tests");
    ...
    fn test_scaling_decision_no_action() {
        ...
        let decision = scaler
            .evaluate_scaling("test-service", 2, &normal_usage, 100.0)
            .expect("Scaling evaluation should succeed in tests");
