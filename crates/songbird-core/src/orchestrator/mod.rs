...
pub struct Orchestrator {
    ...
    services:
        Arc<parking_lot::RwLock<HashMap<String, songbird_discovery::traits::service::ServiceInfo>>>,
    service_health: Arc<parking_lot::RwLock<HashMap<String, ServiceHealth>>>,
    service_metrics: Arc<
        parking_lot::RwLock<HashMap<String, songbird_discovery::traits::service::ServiceMetrics>>,
    >,
}
...
impl Orchestrator {
    ...
    pub async fn get_services(&self) -> Vec<songbird_discovery::traits::service::ServiceInfo> {
    ...
    pub async fn get_service(
        &self,
        service_id: &str,
    ) -> Option<songbird_discovery::traits::service::ServiceInfo> {
    ...
    pub async fn register_service(
        ...
        // Initialize metrics
        let metrics = songbird_discovery::traits::service::ServiceMetrics {
            request_count: 0,
            error_count: 0,
    ...
    pub async fn get_service_metrics(
        &self,
        service_id: &str,
    ) -> Option<songbird_discovery::traits::service::ServiceMetrics> {
    ...
    pub async fn get_all_service_metrics(
        &self,
    ) -> HashMap<String, songbird_discovery::traits::service::ServiceMetrics> {
