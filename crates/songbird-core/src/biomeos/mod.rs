...
//!
//! The BiomeOS integration system is organized into focused modules:
//! - `types` - All data structures and enums for BiomeOS communication
//! - `client` - BiomeOSClient for API communication with BiomeOS
...
mod tests {
    ...
    #[test]
    fn test_ecosystem_message_targeted() {
        let message = EcosystemMessage::new_targeted(
    ...
    fn test_default_configs() {
        let health_config = BiomeOSHealthCheckConfig::default();
        assert_eq!(health_config.endpoint, "/health");
