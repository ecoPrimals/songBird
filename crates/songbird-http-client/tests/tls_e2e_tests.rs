...
async fn test_github_https_handshake() {
    ...
    let result = timeout(Duration::from_secs(10), client.get("https://api.github.com")).await;
...
async fn test_cloudflare_https_handshake() {
    ...
    let result = timeout(Duration::from_secs(10), client.get("https://cloudflare.com")).await;
...
async fn test_google_https_handshake() {
    ...
    let result = timeout(Duration::from_secs(10), client.get("https://www.google.com")).await;
...
async fn test_mozilla_https_handshake() {
    ...
    let result = timeout(Duration::from_secs(10), client.get("https://www.mozilla.org")).await;
...
async fn test_rust_lang_https_handshake() {
    ...
    let result = timeout(Duration::from_secs(10), client.get("https://www.rust-lang.org")).await;
...
async fn test_crates_io_https_handshake() {
    ...
    let result = timeout(Duration::from_secs(10), client.get("https://crates.io")).await;
    ...
    let handles: Vec<_> = (0..3)
        .map(|i| {
            ...
            tokio::spawn(async move {
                let result =
                    timeout(Duration::from_secs(10), client.get("https://api.github.com")).await;
...
async fn test_post_request() {
    ...
    let result =
        timeout(Duration::from_secs(10), client.post("https://httpbin.org/post", body)).await;
...
async fn test_large_response() {
    ...
    let result =
        timeout(Duration::from_secs(15), client.get("https://httpbin.org/bytes/10240")).await;
...
async fn test_redirect_handling() {
    ...
    let result =
        timeout(Duration::from_secs(10), client.get("https://httpbin.org/redirect/1")).await;
...
async fn test_invalid_hostname() {
    ...
    let result =
        timeout(Duration::from_secs(5), client.get("https://this-domain-does-not-exist-12345.com"))
            .await;
...
async fn test_different_tls_servers() {
    ...
    let servers =
        vec!["https://www.wikipedia.org", "https://www.amazon.com", "https://www.microsoft.com"];

    for server in servers {
        let result = timeout(Duration::from_secs(10), client.get(server)).await;
