...
use super::config::{ExtensionType, ExtensionSet};
    ...
    pub fn record_failure(
        ...
        // Update server profile
        {
            ...
            for ext in &extensions {
                if !profile.successful_extensions.contains(ext) && !profile.failed_extensions.contains(ext) {
...
mod tests {
    ...
    fn test_global_stats() {
        ...
        profiler.record_success("server1.com", ExtensionSet::standard().extensions, 0x1301, Duration::from_secs(1));
        profiler.record_success("server2.com", ExtensionSet::standard().extensions, 0x1301, Duration::from_secs(1));
        profiler.record_failure("server3.com", ExtensionSet::modern().extensions, Some(0x1303), "refused");
    ...
    fn test_clear_profiles() {
        ...
        profiler.record_success("test.com", ExtensionSet::standard().extensions, 0x1301, Duration::from_secs(1));
