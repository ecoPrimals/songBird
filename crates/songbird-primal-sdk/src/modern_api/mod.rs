...
pub struct ServiceMetadata  {/// Name identifier
 pub name: String,
    /// Version string
    pub version: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ContactInfo  {/// Name identifier
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ResourceSpec  {/// Min Memory Mb field
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RateLimitInfo  {/// Requests Per Minute field
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IntegrationPreferences  {/// Load Balancing field
...
#[derive(Debug, Clone)]
pub struct UniversalCapabilityDiscovery  {// Implementation details
