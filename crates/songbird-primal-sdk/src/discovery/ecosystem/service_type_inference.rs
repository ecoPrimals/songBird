...
pub fn get_default_capabilities_for_service_type(service_type: &str) -> Vec<PrimalCapability> {
    match service_type.to_lowercase().to_string().as_str() {
        ...
        "gaming" | "retro-gaming" | "multiplayer" => vec!["
            PrimalCapability::Gaming  {protocols: vec![
        ...
        "monitoring" | "observability" | "metrics" => vec!["
            PrimalCapability::Monitoring  {features: vec![
                    "metrics".to_string()),
                    "logs".to_string()),
                    "traces".to_string()),
                ])
        ...
        "communication" | "messaging" | "chat" => vec!["
            PrimalCapability::Messaging  {protocols: vec![
                    "mqtt".to_string()),
                    "amqp".to_string()),
                    "websocket".to_string()),
                ])
...
//
//     #[test]
//     fn test_infer_service_type_from_name()  {//         let test_cases = vec![
...
//
//     #[test]
//     fn test_case_insensitive_service_type_inference()  {//         let test_cases = vec![
//             ("SECURITY-AUTH", "security"),"
//             ("Storage-Service", "storage"),"
//             ("Compute-SERVICE", "compute"),"
//             ("AI-service", "ai"),"
...
//
//     #[test]
//     fn test_service_type_capability_consistency()  {//         // Test that inferring service type and then getting capabilities works consistently
