...
//
//     #[test]
//     fn test_serverless_detection_agnostic()  {//         let capabilities = infer_container_capabilities_from_context(
//             "lambda-function","
...
//
//     #[test]
//     fn test_deployment_capabilities_universal()  {//         let capabilities = infer_deployment_capabilities_universal(&[
...
//
//     #[test]
//     fn test_no_hardcoded_orchestrator_names()  {//         let capabilities = infer_container_capabilities_from_context(
