...
//! - `universal_primal_support` - Universal primal service support with capability-based discovery
...
//! - `universal_discovery` - Universal discovery engine
...
pub mod universal_primal_support;
...
pub use universal_primal_support::{
...
// Network scan functionality removed - using universal primal discovery methods
pub use parsing::{
...
pub use universal_discovery::{UniversalDiscoveryEngine, DiscoveredService, ServiceCapability};
...
) -> SongbirdResult<Vec<crate::discovery::types::DiscoveredPrimal>> {
