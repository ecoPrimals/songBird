...
pub struct UniversalPrimalConfig  {/// Whether to enable auto-discovery of primals
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PrimalInstanceConfig  {/// Base URL for the primal service
    pub base_url: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MultiInstanceConfig  {/// Maximum number of instances per primal type
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct InstanceLifecycleConfig  {/// Whether to automatically start instances
    pub auto_start: bool,
...
/// Port management configuration
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PortManagementConfig  {/// Port range for dynamic allocation
...
/// Security configuration
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SecurityConfig  {/// Whether to enable TLS
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FailoverConfig  {/// Whether to enable failover
    pub enabled: bool,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ScalingConfig  {/// Whether to enable auto-scaling
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PortRange  {/// Start port
    pub start: u16,
...
/// Port allocation strategy
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum PortAllocationStrategy  {/// Sequential allocation
    Sequential,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct HealthMonitoringConfig  {/// Whether to enable health monitoring
    pub enabled: bool,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct EncryptionConfig  {/// Whether to enable encryption
    pub enabled: bool,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MonitoringConfig  {/// Whether to enable metrics collection
...
/// Tracing configuration
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TracingConfig  {/// Whether to enable tracing
    pub enabled: bool,
...
impl Default for UniversalPrimalConfig  {fn default() -> Self  {Self {
...
impl Default for MultiInstanceConfig  {fn default() -> Self  {Self {
...
impl Default for InstanceLifecycleConfig  {fn default() -> Self  {Self {
            auto_start: true,
            auto_stop: true,
...
impl Default for PortManagementConfig  {fn default() -> Self  {Self {
...
impl Default for FailoverConfig  {fn default() -> Self  {Self {
            enabled: true,
            max_retries: 3,
...
impl PrimalInstanceConfig  {/// Create a new instance configuration
    pub fn new(base_url: String, instance_id: String, user_id: String, device_id: String) -> Self  {Self {
            base_url)
            instance_id)
            user_id)
            device_id)
