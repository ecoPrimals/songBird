...
pub enum PrimalCapability  {/// AI model inference capability
    ModelInference {
        models: Vec<String>,
    })
...
impl PrimalCapability {
    ...
    pub fn is_compatible_with(&self, other: &Self) -> bool  {matches!(
            (self, other)
            (Self::ModelInference { .. }, Self::AgentFramework { .. })
                | (Self::NetworkDiscovery { .. }, Self::ServiceDiscovery { .. })
                | (Self::ContainerOrchestration { .. }, Self::ServiceMesh { .. })
                | (Self::ServiceDiscovery { .. }, Self::LoadBalancing { .. })
        )
    }
}
...
pub struct CapabilityPerformance  {/// Average response time in milliseconds
...
impl Default for CapabilityPerformance  {fn default() -> Self  {Self {
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
pub struct ResourceRequirements  {/// Minimum CPU cores required
...
impl Default for ResourceRequirements  {fn default() -> Self  {Self {
...
pub struct NetworkRequirements  {/// Minimum bandwidth in Mbps
...
impl Default for NetworkRequirements  {fn default() -> Self  {Self {
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct CapabilityDependency  {/// Name of the required capability
...
impl CapabilityDependency  {/// Create a new required capability dependency
    pub fn required(capability_name: &str) -> Self  {Self {
    ...
    pub fn optional(capability_name: &str) -> Self  {Self {capability_name: capability_name.to_string()),
            min_version: None,
            optional: true,
            parameters: HashMap::new()),
        }
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct CapabilityConfig  {/// Capability identifier
    pub id: String,
...
impl CapabilityConfig  {/// Create a new capability configuration
    pub fn new(id: &str, name: &str, version: &str) -> Self  {Self {
            id: id.to_string(),
            name: name.to_string(),
