...
pub enum SecurityLevel  {/// Basic user-level security
    User,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Hash)]
pub struct NetworkLocation  {/// Network region
    pub region: String,
    /// Availability zone
...
impl Default for NetworkLocation  {fn default() -> Self  {Self {
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, Hash)]
pub struct DynamicPortInfo  {/// Port number
    pub port: u16,
...
impl DynamicPortInfo  {/// Create new dynamic port info
    #[must_use]
    pub fn new(port: u16, protocol: impl Into<String>, host: impl Into<String>) -> Self  {Self {
            port,
    ...
    #[must_use]
    pub fn url(&self) -> String  {let scheme = if self.tls_enabled {
...
pub struct PrimalEndpoints  {/// Primary endpoint
    pub primary: String,
    /// Backup endpoints
...
impl PrimalEndpoints  {/// Create new primal endpoints
    #[must_use]
    pub fn new(primary: impl Into<String>) -> Self  {Self {
...
pub struct PrimalContext  {/// User identifier
...
pub struct PrimalConfig  {/// Instance-specific configuration
