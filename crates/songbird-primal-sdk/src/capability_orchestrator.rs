...
pub struct CapabilityOrchestrator  {/// Capability registry (what capabilities are available)
...
impl CapabilityOrchestrator {
    ...
    async fn update_registries(&self) -> SongbirdResult<()>  {let mut capability_registry = self.capability_registry.write().await;
...
impl CapabilityRegistry {
    ...
    pub fn list_all_capabilities(&self) -> Vec<AvailableCapability>  {self.all_capabilities
            .iter()
...
impl OrchestrationEngine  {
    ...
    pub async fn execute_workflow(&self) -> Result<WorkflowResult, SongbirdError> {
        ...
        // Update workflow status
         {let mut active_workflows = self.active_workflows.write().await;
            if let Some(active_workflow) = active_workflows.get_mut(&workflow_id)  {active_workflow.status = match &result {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CapabilityWorkflow  {pub id: String,
    pub name: String,
    pub description: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct WorkflowStep  {pub id: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct WorkflowResult  {pub workflow_id: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AvailableCapability  {pub name: String,
    pub provider_count: usize,
    pub description: String,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CapabilityHealth  {pub capability: String,
...
pub struct CapabilityPreferences  {pub preferred_provider_type: Option<String>,
...
#[derive(Debug, Clone)]
pub struct CapabilityOrchestratorConfig  {pub request_timeout_secs: u64,
    pub discovery_interval_secs: u64,
    pub health_check_interval_secs: u64,
    pub max_concurrent_workflows: usize,
}

impl Default for CapabilityOrchestratorConfig  {fn default() -> Self  {Self {
