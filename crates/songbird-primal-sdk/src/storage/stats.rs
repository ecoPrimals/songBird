...
pub struct StorageStats  {/// Total number of read operations
    pub total_reads: u64,
...
impl Default for StorageStats  {fn default() -> Self  {Self {
            total_reads: 0,
            total_writes: 0,
            total_deletes: 0,
            total_failures: 0,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ProviderPerformanceStats  {pub provider_name: String,
...
impl Default for ProviderPerformanceStats  {fn default() -> Self  {Self {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct EcosystemHealthMetrics  {/// Overall system health score (0.0 to 1.0)
