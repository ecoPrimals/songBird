...
#[derive(Debug)]
pub struct AgnosticServiceDiscovery {
    /// Registry of discovered capability providers
...
pub struct CapabilityRegistry {
    /// Map of capability to providers that offer it
...
pub struct ProviderDetails {
    /// Provider name (learned, not hardcoded)
    /// Name identifier
    pub name: String,
    /// Version information
    /// Version string
...
;
 ...
 ;
    ...
    async fn update_capability_registry() {
