...
pub trait UniversalAdapter: Provider {
    ...
    async fn send_request(&self, request: crate::types::UniversalRequest) -> SongbirdResult<crate::types::UniversalResponse>;
    
    /// Register service provider
    async fn register_provider(&mut self, provider: Box<dyn ServiceProvider>) -> SongbirdResult<()>;
}
