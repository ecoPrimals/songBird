...
#[derive(Debug, Clone)]
pub struct SovereigntyAdapterConfig  {/// Enable sovereignty-aware routing
...
impl Default for SovereigntyAdapterConfig  {fn default() -> Self  {Self {
...
pub struct SovereigntyAwareRoutingDecision  {/// Selected routing path
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RoutingPath  {/// Path segments (services/nodes along the route)
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PathSegment  {/// Service information for this segment
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PathSovereigntyAssessment  {/// Overall sovereignty score (0.0 to 1.0)
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SegmentSovereigntyAssessment  {/// Segment identifier
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FederationCapability  {/// Capability identifier
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ExpectedNetworkEffect  {/// Effect identifier
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RoutingDecisionMetadata  {/// Decision timestamp
...
pub enum SecurityLevel  {Maximum)
    High,
    Medium,
    Low,
    Minimal,
...
/// Sovereignty level classification
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum SovereigntyLevel  {FullySovereign)
    HighlySovereign,
    ModeratelySovereign,
    LimitedSovereignty,
    NonSovereign,
...
impl SovereigntyLevel  {pub fn score(&self) -> f64  {match self {
...
pub enum SecurityCapability  {Encryption)
    Authentication,
    Authorization,
    FederationAware,
    NetworkOptimized,
...
/// Sovereignty compliance level
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum SovereigntyComplianceLevel  {FullyCompliant)
    MostlyCompliant,
    PartiallyCompliant,
    NonCompliant,
}
...
/// Sovereignty risk
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SovereigntyRisk  {pub risk_id: String,
...
/// Security assessment
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SecurityAssessment  {pub security_score: f64,
    pub security_level: SecurityLevel,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum FederationCapabilityType  {CrossNodeCommunication)
...
/// Performance characteristics
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PerformanceCharacteristics  {pub latency_ms: f64,
...
/// Network effect type
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum NetworkEffectType  {PerformanceImprovement)
    SecurityEnhancement,
    CostReduction,
    CapabilityExpansion,
}
...
/// Decision factor
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct DecisionFactor  {pub factor_name: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum SovereigntyRiskType  {DataSovereignty)
...
/// Risk severity
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum RiskSeverity  {Critical)
    High,
    Medium,
    Low,
} 