...
async fn test_concurrent_multi_adapter_discovery() {
    ...
    songbird_process_env::set_var("CAPABILITY_SECURITY_ENDPOINT", "http://security-test:8443");
    songbird_process_env::set_var("CAPABILITY_STORAGE_ENDPOINT", "http://storage-test:9000");
    songbird_process_env::set_var("CAPABILITY_AI_ENDPOINT", "http://ai-test:8888");
...
async fn test_legacy_environment_variable_fallback() {
    ...
    songbird_process_env::set_var("BEARDOG_ENDPOINT", "http://legacy-security:8443");
    songbird_process_env::set_var("NESTGATE_ENDPOINT", "http://legacy-storage:9000");
    songbird_process_env::set_var("SQUIRREL_ENDPOINT", "http://legacy-ai:8888");
...
async fn test_host_port_construction_fallback() {
    ...
    songbird_process_env::set_var("SONGBIRD_HOST", "http://fallback-host");
    songbird_process_env::set_var("SONGBIRD_COMPUTE_PORT", "9999");
    ...
    songbird_process_env::remove_var("SONGBIRD_COMPUTE_PORT");
}
...
async fn test_discovery_priority_order() -> SongbirdResult<()> {
    ...
    songbird_process_env::set_var("CAPABILITY_SECURITY_ENDPOINT", "http://new-priority:8443");
    songbird_process_env::set_var("BEARDOG_ENDPOINT", "http://old-legacy:8443");
...
async fn test_capability_type_boundaries() -> SongbirdResult<()> {
    ...
    songbird_process_env::set_var("CAPABILITY_COMPUTE_ENDPOINT", "http://compute:1111");
    songbird_process_env::set_var("CAPABILITY_SECURITY_ENDPOINT", "http://security:2222");
    songbird_process_env::set_var("CAPABILITY_STORAGE_ENDPOINT", "http://storage:3333");
    songbird_process_env::set_var("CAPABILITY_AI_ENDPOINT", "http://ai:4444");
...
async fn test_mixed_environment_configuration() {
    ...
    songbird_process_env::set_var("BEARDOG_ENDPOINT", "http://security-legacy:8443");
    songbird_process_env::set_var("SONGBIRD_HOST", "http://fallback-host");
    songbird_process_env::set_var("SONGBIRD_AI_PORT", "7777");
...
async fn test_discovery_consistency() {
    songbird_process_env::set_var("CAPABILITY_STORAGE_ENDPOINT", "http://consistent:9000");
