...
impl Default for MockBearDogProvider {
    fn default() -> Self {
        Self::new()
    }
}
...
impl LineageProvider for MockBearDogProvider {
...
#[async_trait::async_trait]
impl BirdSongCrypto for MockBearDogProvider {
...
#[async_trait::async_trait]
impl LineageRelay for MockBearDogProvider {
...
#[async_trait::async_trait]
impl BearDogProvider for MockBearDogProvider {
