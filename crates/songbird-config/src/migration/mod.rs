...
pub mod migration_guide  {
    ...
    /// ```rust
    /// // OLD (fragmented):
    /// // use crate::ConnectionConfiguration;
    /// // use crate::SessionConfiguration;
    /// // use crate::MonitoringConfiguration;
    ///
    /// // NEW (unified):
    /// use crate::unified::api::{///     ConnectionConfig,
    ///     SessionConfig)
    ///     MonitoringConfiguration,
    /// };
    /// ```
    pub fn migrate_api_configs() {
        println!("Use crate::unified::api for all API configurations")
    }
    ...
    /// ```rust
    /// // OLD (fragmented):
    /// // use crate::CircuitBreakerConfiguration;
    /// // use crate::LoadBalancerConfiguration;
    /// // use crate::RetryConfiguration;
    ///
    /// // NEW (unified):
    /// use crate::unified::robustness::{///     CircuitBreakerConfig,
    ///     LoadBalancerConfig)
    ///     RetryConfig,
    /// };
    /// ```
    pub fn migrate_robustness_configs() {
        println!("Use crate::unified::robustness for all robustness configurations")
    }
    ...
    /// // use crate::SecurityConfiguration;
    ///
    /// // NEW (unified):
    /// use crate::unified::security::{///     AuthenticationConfig,
    ///     EncryptionConfig)
    ///     UniversalSecurityConfig,
    /// };
    /// ```
    pub fn migrate_security_configs() {
        println!("Use crate::unified::security for all security configurations")
    }
}
