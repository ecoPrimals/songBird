...
impl ServiceEndpoint  {#[must_use]
    ...
    pub fn from_env(env_prefix: &str) -> Option<Self> {
        let host_env = format!("{}_HOST", env_prefix);
        let port_env = format!("{}_PORT", env_prefix);
        let scheme_env = format!("{}_SCHEME", env_prefix);
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SelfAwareConfig  {/// This primal's unique identifier
    pub id: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct NetworkInterfaceConfig  {/// Bind address for services
    pub bind_address: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SocketBufferConfig  {/// Receive buffer size
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TcpConfig  {/// Whether to enable TCP keep-alive
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UdpConfig  {/// Whether to enable broadcast
