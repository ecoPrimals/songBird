...
pub struct UnifiedDiscoveryConfig  {pub service_discovery: ServiceDiscoveryConfig,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ServiceDiscoveryConfig  {pub enabled: bool,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CapabilityDiscoveryConfig  {pub enabled: bool,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct NetworkDiscoveryConfig  {pub enabled: bool,
