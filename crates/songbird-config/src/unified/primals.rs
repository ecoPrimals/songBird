...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PrimalDiscoveryConfig  {pub auto_discovery: bool,
    pub discovery_interval_secs: u64,
    pub discovery_timeout_secs: u64,
    pub max_discovery_attempts: u32,
}

impl Default for PrimalDiscoveryConfig  {fn default() -> Self  {Self {
            auto_discovery: true,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PrimalRoutingConfig  {pub load_balancing_strategy: String,
    pub circuit_breaker_enabled: bool,
    pub max_retries: u32,
    pub retry_delay_ms: u64,
}

impl Default for PrimalRoutingConfig  {fn default() -> Self  {Self {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PrimalHealthConfig  {pub health_check_interval_secs: u64,
    pub health_check_timeout_secs: u64,
    pub unhealthy_threshold: u32,
    pub recovery_threshold: u32,
}

impl Default for PrimalHealthConfig  {fn default() -> Self  {Self {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PrimalEndpointConfig  {pub endpoint: Option<String>,
    pub enabled: bool,
    pub capabilities: Vec<String>,
    pub priority: u32,
}

impl Default for PrimalEndpointConfig  {fn default() -> Self  {Self {
            endpoint: None,
            enabled: false,
