...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ServiceCapability  {/// Capability type (dot-notation)
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ServiceEndpoint  {/// Type of endpoint
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SongbirdMetadata  {/// Instance name
    pub name: String,
    ...
    pub fn new() -> Self {
        ...
        Self  {service_id: Uuid::new_v4()
            capabilities: vec![
                ...
                ServiceCapability  {capability_type: "orchestration.networking".to_string()),
                ...
                ServiceCapability  {capability_type: "networking.discovery".to_string()),
                ...
                ServiceCapability  {capability_type: "orchestration.federation".to_string()),
                ...
                ServiceCapability  {capability_type: "networking.gaming".to_string()),
            ...
            endpoints: vec![
                ServiceEndpoint  {endpoint_type: "orchestration".to_string()),
                    url: base_url.clone(,
                    health_check_path: Some("/health".to_string(),"
                })
                ServiceEndpoint  {endpoint_type: "api".to_string()),
                    url: api_base_url.clone(,
                    health_check_path: Some("/api/health".to_string(),"
                })
            ])
            metadata: SongbirdMetadata  {name: "Songbird Universal Orchestrator".to_string(),
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CapabilityDiscoveryConfig  {/// Discovery methods to use
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ManualServiceRegistration  {/// Service identifier
...
impl Default for CapabilityDiscoveryConfig  {fn default() -> Self  {Self {
            discovery_methods: vec![
                "mdns".to_string()),
                "dns_sd".to_string()),
                "manual".to_string()),
            ])
            discovery_timeout_secs: songbird_types::constants::TimeoutConstants::DEFAULT_DISCOVERY_TIMEOUT.as_secs() as u64,
            capability_cache_ttl_secs: songbird_types::constants::TimeoutConstants::DEFAULT_CACHE_TTL.as_secs() as u64,
