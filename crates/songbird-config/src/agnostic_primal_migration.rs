...
#[derive(Debug)]
pub struct AgnosticPrimalMigrator {
    /// Mapping from hardcoded primal names to capabilities
...
pub struct CapabilityMapping {
    /// Original hardcoded primal name
...
pub struct ConfigPattern  {
    ...
    /// Configuration key pattern to match
...
impl AgnosticPrimalMigrator {
    /// Create a new agnostic primal migrator with standard mappings
    pub fn new() -> Self {
    ...
    fn initialize_standard_mappings(&mut self) {
        ...
        // Security capabilities (was "beardog")
    ...
    fn initialize_code_patterns(&mut self) {
         
         
        // Replace hardcoded primal name strings
    ...
    fn initialize_config_patterns(&mut self) {
        ...
        // Migrate primal-specific config sections
    ...
    pub async fn generate_migration_report(&self, directory_path: &str) -> SongbirdResult<MigrationReport> {
