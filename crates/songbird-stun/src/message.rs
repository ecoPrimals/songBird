...
impl StunMessage {
    ...
    pub fn encode(&self) -> Bytes {
        ...
        buf[length_offset..length_offset + 2].copy_from_slice(&(message_length as u16).to_be_bytes());
    ...
    fn encode(&self, buf: &mut BytesMut) {
        match self {
            ...
            Self::XorMappedAddress(addr) => {
                Self::encode_address(buf, AttributeType::XorMappedAddress, addr, Some(MAGIC_COOKIE));
            }
