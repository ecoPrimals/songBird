...
pub struct InitConfig  {/// Deployment type
...
impl Default for InitConfig  {fn default() -> Self  {let home_dir = dirs::home_dir().unwrap_or_else(|| PathBuf::from(".");"
...
fn save_configuration(
    ...
    let cli_config = crate::cli::config::CliConfig  {config_dir: init_config.config_dir.clone()
