...
mod tests {
    ...
    async fn test_subscription() {
        ...
        let _rx = broadcaster
            .subscribe("client1".to_string(), vec!["service_update".to_string()])
            .await;
    ...
    async fn test_unsubscribe() {
        ...
        broadcaster
            .unsubscribe("client1", vec!["service_update".to_string()])
            .await;
        ...
        broadcaster
            .unsubscribe("client1", vec!["health_update".to_string()])
            .await;
