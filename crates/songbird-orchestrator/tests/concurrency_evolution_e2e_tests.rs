...
async fn test_e2e_realistic_test_suite_pattern() {
    ...
    let test_cases = vec![
        TestCase { name: "help", args: vec!["--help"], should_succeed: true },
        TestCase { name: "version", args: vec!["--version"], should_succeed: true },
        TestCase { name: "invalid1", args: vec!["bad"], should_succeed: false },
        TestCase { name: "invalid2", args: vec!["wrong"], should_succeed: false },
    ];
