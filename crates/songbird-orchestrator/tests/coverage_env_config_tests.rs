...
fn test_primal_name_from_env() {
    let _g = lock_env();
    std::env::set_var("PRIMAL_NAME", "custom-primal");
...
fn test_family_id_priority_highest() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_ORCHESTRATOR_FAMILY_ID", "highest");
    std::env::set_var("SONGBIRD_ORCHESTRATOR_FAMILY", "lower");
    std::env::set_var("BIOMEOS_FAMILY_ID", "lowest");
    std::env::set_var("SONGBIRD_FAMILY_ID", "legacy");
    std::env::set_var("FAMILY_ID", "generic");
...
fn test_family_id_priority_second() {
    ...
    std::env::set_var("SONGBIRD_ORCHESTRATOR_FAMILY", "second");
    std::env::set_var("BIOMEOS_FAMILY_ID", "lower");
    let id = env_config::family_id();
...
fn test_family_id_priority_biomeos() {
    ...
    std::env::remove_var("SONGBIRD_ORCHESTRATOR_FAMILY_ID");
    std::env::remove_var("SONGBIRD_ORCHESTRATOR_FAMILY");
    std::env::set_var("BIOMEOS_FAMILY_ID", "biome-fam");
...
fn test_family_id_priority_legacy() {
    ...
    std::env::remove_var("SONGBIRD_ORCHESTRATOR_FAMILY");
    std::env::remove_var("BIOMEOS_FAMILY_ID");
    std::env::set_var("SONGBIRD_FAMILY_ID", "legacy-id");
    std::env::remove_var("FAMILY_ID");
    let id = env_config::family_id();
    std::env::remove_var("SONGBIRD_FAMILY_ID");
...
fn test_family_id_priority_generic() {
    ...
    std::env::remove_var("BIOMEOS_FAMILY_ID");
    std::env::remove_var("SONGBIRD_FAMILY_ID");
    std::env::set_var("FAMILY_ID", "generic-id");
    let id = env_config::family_id();
    std::env::remove_var("FAMILY_ID");
...
fn test_node_id_primary() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_NODE_ID", "node-42");
    std::env::set_var("NODE_ID", "generic-node");
...
fn test_socket_path_explicit_override() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_SOCKET", "/custom/path/songbird.sock");
...
fn test_socket_name_multi_family_via_family_socket_flag() {
    let _g = lock_env();
    std::env::remove_var("SONGBIRD_MULTI_FAMILY");
    std::env::set_var("SONGBIRD_FAMILY_SOCKET", "1");
    for var in &[
        "SONGBIRD_ORCHESTRATOR_FAMILY_ID",
        "SONGBIRD_ORCHESTRATOR_FAMILY",
        "BIOMEOS_FAMILY_ID",
...
fn test_socket_name_multi_family_with_custom_family() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_MULTI_FAMILY", "true");
    std::env::set_var("FAMILY_ID", "alpha-bravo");
    std::env::remove_var("SONGBIRD_ORCHESTRATOR_FAMILY_ID");
    std::env::remove_var("SONGBIRD_ORCHESTRATOR_FAMILY");
    std::env::remove_var("BIOMEOS_FAMILY_ID");
    std::env::remove_var("SONGBIRD_FAMILY_ID");
...
fn test_socket_name_multi_family_disabled() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_MULTI_FAMILY", "false");
    let name = env_config::socket_name();
    std::env::remove_var("SONGBIRD_MULTI_FAMILY");
...
fn test_data_dir_from_env() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_DATA_DIR", "/custom/data");
...
fn test_deployment_dir_default() {
    let _g = lock_env();
    std::env::remove_var("SONGBIRD_DEPLOY_DIR");
...
fn test_deployment_dir_from_env() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_DEPLOY_DIR", "/opt/deployments");
...
fn test_cache_dir_default() {
    let _g = lock_env();
    std::env::remove_var("SONGBIRD_CACHE_DIR");
...
fn test_cache_dir_from_env() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_CACHE_DIR", "/var/cache/songbird");
...
fn test_http_bind_address_from_env() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_HTTP_ADDR", "127.0.0.1:9090");
...
fn test_http_port_extracted_from_addr() {
    let _g = lock_env();
    std::env::remove_var("SONGBIRD_HTTP_PORT");
    std::env::set_var("SONGBIRD_HTTP_ADDR", "0.0.0.0:3000");
    let port = env_config::http_port();
    std::env::remove_var("SONGBIRD_HTTP_ADDR");
    assert_eq!(port, 3000);
}
...
fn test_http_port_invalid_env_falls_back() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_HTTP_PORT", "not-a-number");
    let port = env_config::http_port();
    std::env::remove_var("SONGBIRD_HTTP_PORT");
    assert_eq!(port, 8080);
}
...
fn test_log_level_songbird_log() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_LOG", "debug");
...
fn test_dark_forest_enabled_default_false() {
    let _g = lock_env();
    std::env::remove_var("SONGBIRD_DARK_FOREST");
...
fn test_dark_forest_enabled_true() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_DARK_FOREST", "true");
...
fn test_dark_forest_enabled_invalid_value() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_DARK_FOREST", "not-a-bool");
    let enabled = env_config::dark_forest_enabled();
    std::env::remove_var("SONGBIRD_DARK_FOREST");
    assert!(!enabled);
}
...
fn test_accept_legacy_birdsong_default_true() {
    let _g = lock_env();
    std::env::remove_var("SONGBIRD_ACCEPT_LEGACY_BIRDSONG");
...
fn test_accept_legacy_birdsong_disabled() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_ACCEPT_LEGACY_BIRDSONG", "false");
...
fn test_dual_broadcast_enabled() {
    let _g = lock_env();
    std::env::set_var("SONGBIRD_DUAL_BROADCAST", "true");
