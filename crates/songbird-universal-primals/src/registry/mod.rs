...
pub struct UniversalPrimalRegistry {
    /// Map of instance ID to primal provider (using object-safe trait)
            ...
            let capabilities = provider
                ...
                .map(|cap| {
                    ...
                    let (capability_type, parameters) = match cap {
                        crate::traits::capabilities::PrimalCapability::Storage { types } => {
                        ...
                        crate::traits::capabilities::PrimalCapability::Compute { types } => {
                            let mut params = std::collections::HashMap::new();
                            params.insert(
                                "types".to_string(),
                                serde_json::Value::Array(
                        ...
                        crate::traits::capabilities::PrimalCapability::AI { models } => {
                            let mut params = std::collections::HashMap::new();
                            params.insert(
                                "models".to_string(),
                                serde_json::Value::Array(
                        ...
                        crate::traits::capabilities::PrimalCapability::Authentication {
                            methods,
                        } => {
                            let mut params = std::collections::HashMap::new();
                            params.insert(
                        ...
                        crate::traits::capabilities::PrimalCapability::Networking { protocols } => {
                            let mut params = std::collections::HashMap::new();
                            params.insert(
                                "protocols".to_string(),
                                serde_json::Value::Array(
                        ...
                        crate::traits::capabilities::PrimalCapability::ServiceDiscovery {
                            protocols,
                        } => {
                            let mut params = std::collections::HashMap::new();
                            params.insert(
                        ...
                        crate::traits::capabilities::PrimalCapability::Security { protocols } => {
                            let mut params = std::collections::HashMap::new();
                            params.insert(
                                "protocols".to_string(),
                                serde_json::Value::Array(
                        ...
                        crate::traits::capabilities::PrimalCapability::Custom {
                            name,
                            attributes,
                        } => {
                            let mut params = std::collections::HashMap::new();
                    ...
                    songbird_universal::PrimalCapability {
                        capability_type,
