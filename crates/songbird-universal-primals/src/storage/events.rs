...
pub enum UniversalStorageEvent {
    ...
    pub fn is_error(&self) -> bool {
        matches!(
            ...
            UniversalStorageEvent::OperationFailed { .. }
                ...
                | UniversalStorageEvent::PerformanceAlert {
                ...
                | UniversalStorageEvent::BackupEvent {
    ...
    pub fn is_success(&self) -> bool {
        matches!(
            ...
            UniversalStorageEvent::DataStored { .. }
                ...
                | UniversalStorageEvent::CacheEvent {
...
mod tests {
    ...
    fn test_event_classification() {
        let success_event = UniversalStorageEvent::DataStored {
            key: "test".to_string(),
            size_bytes: 1024,
            provider: "test-provider".to_string(),
            timestamp: SystemTime::now(),
        ...
        let error_event = UniversalStorageEvent::OperationFailed {
