...
pub use songbird_errors::{SongbirdError, SongbirdResponse, SongbirdResult, success};
...
pub struct ServiceCapability {
    /// Capability name (e.g., "encryption", "storage", "ai-inference")
    pub name: String,
...
pub trait ZeroCostPrimalProvider {
    /// Associated types for zero-cost specialization
...
impl UniversalCapabilityDiscovery {
    /// Create a new capability discovery engine
    pub fn new() -> Self {
        Self {
    ...
    pub async fn discover_by_capability(
        ...
        Ok(songbird_errors::evolved_success(SongbirdResponse::success(services)))
    }
    ...
    pub async fn find_best_service(
        ...
        Ok(songbird_errors::evolved_success(SongbirdResponse::success(best_service)))
    }
