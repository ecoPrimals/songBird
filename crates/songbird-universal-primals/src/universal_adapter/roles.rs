...
impl RoleMatcher {
    ...
    pub async fn initialize_standard_roles(&self) -> SongbirdResult<()> {
        ...
        roles.insert(
            ...
            ServiceRole {
                role_id: "ecosystem.security_provider".to_string(),
        ...
        roles.insert(
            ...
            ServiceRole {
                role_id: "ecosystem.storage_provider".to_string(),
                required_capabilities: vec![CapabilityRequirement {
                    capability_type: "data_persistence".to_string(),
        ...
        roles.insert(
            ...
            ServiceRole {
                role_id: "ecosystem.compute_provider".to_string(),
                required_capabilities: vec![CapabilityRequirement {
                    capability_type: "computation".to_string(),
    ...
    pub fn service_matches_role(&self, service: &ServiceInstance, role: &ServiceRole) -> bool {
        // Check if service has all required capabilities
        for required_cap in &role.required_capabilities {
            let has_capability = service.capabilities.iter().any(|service_cap| {
    ...
    fn meets_capability_level(&self, actual_level: &str, required_level: &str) -> bool {
        // Simple level comparison - could be enhanced with more sophisticated logic
