...
pub fn infer_capabilities_from_context(
    ...
    if dir_lower.contains("gaming") || dir_lower.contains("game") || dir_lower.contains("retro") {
        capabilities.push(PrimalCapability::Gaming {
            protocols: vec![
...
pub fn infer_capabilities_from_file_patterns(files: &[String]) -> Vec<PrimalCapability> {
    let mut capabilities = Vec::new();
...
//
//     #[test]
//     fn test_universal_container_detection_integration() {
//         // Test that we use universal container detection instead of hardcoding
...
//
//     #[test]
//     fn test_universal_deployment_capabilities() {
//         let capabilities = infer_deployment_capabilities(&[
