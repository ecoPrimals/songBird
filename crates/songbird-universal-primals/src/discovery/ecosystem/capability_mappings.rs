...
pub fn get_capability_type_mappings() -> Vec<(String, Vec<String>)> {
    vec![
...
pub fn get_storage_capabilities() -> Vec<PrimalCapability> {
    vec![
...
pub fn get_ai_capabilities() -> Vec<PrimalCapability> {
    vec![
        PrimalCapability::AI {
            models: vec![
                "llm".to_string(),
...
pub fn get_orchestration_capabilities() -> Vec<PrimalCapability> {
    vec![
...
pub fn get_network_capabilities() -> Vec<PrimalCapability> {
    vec![
...
pub fn get_universal_capabilities() -> Vec<PrimalCapability> {
    vec![
...
//         ];
//
//         for (primal_name, expected_type) in test_cases {
//             let (primal_type, capabilities) = get_default_capabilities_for_primal(primal_name);
//             assert_eq!(
