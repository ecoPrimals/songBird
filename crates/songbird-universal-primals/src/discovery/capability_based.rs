//! Capability-Based Universal Primal Discovery
//!
...
//!
//! **Note**: Renamed from "legacy.rs" - this is active capability-based discovery code,
//! not legacy compatibility. The name "legacy" was misleading.
