...
impl DiscoveryDelegator {
    ...
    pub async fn list_all_services(&self) -> Result<Vec<ServiceInfo>> {
        let query = CapabilityQuery::new(
    ...
    pub async fn get_load_balancing_hints(&self, service_name: &str) -> Result<LoadBalancingHints> {
        let query = CapabilityQuery::new(
    ...
    async fn broadcast_discover_services(&self, query: ServiceQuery) -> Result<Vec<ServiceInfo>> {
        let capability_query = CapabilityQuery::new(
            CapabilityMatcher::new().require(DiscoveryCapability::ServiceDiscovery),
        );
    ...
    async fn broadcast_list_all_services(&self) -> Result<Vec<ServiceInfo>> {
        let query = CapabilityQuery::new(
            CapabilityMatcher::new().require(DiscoveryCapability::ServiceListing),
        );
