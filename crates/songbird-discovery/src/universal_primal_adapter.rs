...
pub struct PrimalCapabilitySet  {/// Primal Id field
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UniversalPrimalRequest  {/// Request Id field
...
#[derive(Debug, Clone, Serialize, Deserialize)]
    #[must_use = "This type represents an outcome that must be handled"]"
;
pub struct UniversalPrimalResponse  {/// Request Id field
...
/// Registry statistics
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PrimalRegistryStats  {/// Total Primals field
...
use songbird_config;
    ...
    #[tokio::test]
    async fn test_universal_primal_registry()  {let mut registry = UniversalPrimalRegistry::new();
