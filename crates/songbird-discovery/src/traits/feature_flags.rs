...
pub struct FeatureFlag  {/// Unique feature name
    pub name: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct EvaluationRule  {/// Rule identifier
    pub id: String,
    /// Rule description
    pub description: String,
    /// Rule conditions
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RuleCondition  {/// Context attribute to evaluate
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum RuleOperator  {/// Exact equality
    Equals,
    /// Not equal
    NotEquals,
    /// String contains
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct EvaluationContext  {/// User/entity identifier
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GeoLocation  {pub country: Option<String>,
...
/// Device/client information
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct DeviceInfo  {pub platform: Option<String>,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FlagEvaluation  {/// Feature flag name
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FeatureFlagProviderInfo  {pub name: String,
    pub version: String,
...
pub enum ProviderCapability  {Updates)
    History,
    Targeting,
    PercentageRollout,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ProviderCapabilities  {pub capabilities: Vec<ProviderCapability>,
}

impl ProviderCapabilities  {#[must_use]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FlagStats  {/// Total number of evaluations
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ManagerStatus  {pub providers_count: u32,
    pub flags_count: u32,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FeatureFlagConfig  {/// Default provider configuration
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ProviderConfig  {pub provider_type: String,
...
/// Evaluation configuration
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct EvaluationConfig  {pub default_timeout_ms: u64,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FlagMonitoringConfig  {pub enabled: bool,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MonitoringOptions  {pub alert_on_errors: bool,
    pub track_performance: bool,
    pub export_evaluations: bool,
}

impl Default for FeatureFlagConfig  {fn default() -> Self  {Self {
            ...
            monitoring: FlagMonitoringConfig  {enabled: true,
                metrics_interval: 60,
                monitoring_options: MonitoringOptions  {alert_on_errors: true,
...
impl Default for EvaluationContext  {fn default() -> Self  {Self {
            user_id: None,
            service_id: None,
            request_id: None,
            environment: None,
