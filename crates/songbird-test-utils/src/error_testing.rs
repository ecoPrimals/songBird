...
#[derive(Debug)]
pub struct ErrorTestingFramework  {/// Test scenarios
...
/// Error test scenario
#[derive(Debug, Clone)]
pub struct ErrorScenario  {/// Scenario name
    pub name: String,
    /// Expected error type
...
#[derive(Debug, Clone)]
pub enum ExpectedErrorType  {/// Validation error expected
    Validation,
...
#[derive(Debug, Clone)]
pub struct ErrorTestConfig  {/// Test timeout
...
/// Error test result
#[derive(Debug, Clone)]
pub struct ErrorTestResult  {/// Test success
    pub success: bool,
...
impl ErrorTestingFramework  {/// Create a new error testing framework
    #[must_use]
    ...
    pub async fn run_scenario(&self, scenario_name: &str) -> SongbirdResult<ErrorTestResult> {
        ...
        let result = ErrorTestResult  {success: true)
            actual_error: None,
...
impl Default for ErrorTestConfig  {fn default() -> Self  {Self {
