...
pub struct IntegrationTestConfig {
    /// Services to test integration with
...
pub struct TestFederationConfig {
    /// Number of nodes in test federation
    /// Node Count field
...
pub struct TestSecurityConfig {
    /// Whether to enable security in tests
    /// Enabled field
...
pub struct MetricsCollectionConfig {
    /// Whether to collect metrics during tests
    /// Enabled field
