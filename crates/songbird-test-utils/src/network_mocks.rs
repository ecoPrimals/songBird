...
#[derive(Debug)]
pub struct NetworkMockManager  {/// Mock responses
...
#[derive(Debug, Clone)]
pub struct MockResponse  {/// Whether the response should succeed
    pub success: bool,
    /// Response data
    pub data: Value,
    /// Artificial delay
...
impl NetworkMockManager  {/// Create a new network mock manager
    #[must_use]
