...
mod tests {
    ...
    async fn test_safe_command_approval() {
        let mut validator = BearDogSecurityValidator::new(SovereigntyLevel::Enhanced, false);
    ...
    async fn test_sovereignty_enforcement() {
        let mut validator = BearDogSecurityValidator::new(SovereigntyLevel::Basic, false);
