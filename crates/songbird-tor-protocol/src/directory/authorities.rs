...
pub const DIRECTORY_AUTHORITIES: &[DirectoryAuthority] = &[
    ...
    DirectoryAuthority {
        ...
        or_port: 443,
        fingerprint: [
            0xF2, 0x04, 0x4D, 0x13, 0xDA, 0x1D, 0xB6, 0x8F,
            0x24, 0x17, 0x4D, 0x98, 0xC3, 0x95, 0xF8, 0x4A,
            0x8C, 0x45, 0x7A, 0x4F,
        ],
    },
    ...
    DirectoryAuthority {
        ...
        or_port: 80,
        fingerprint: [
            0xBD, 0x6A, 0x26, 0xDF, 0xC8, 0x26, 0x8E, 0x0C,
            0x3C, 0x52, 0xFC, 0xF9, 0x9C, 0x78, 0x5B, 0xF9,
            0xD1, 0x4B, 0x83, 0xEE,
        ],
    },
    ...
    DirectoryAuthority {
        ...
        or_port: 443,
        fingerprint: [
            0xCF, 0x6D, 0x0A, 0xAF, 0xB3, 0x85, 0xBE, 0x71,
            0xB8, 0xE1, 0x11, 0xFC, 0x5C, 0xDD, 0x4B, 0x81,
            0x9C, 0x36, 0x08, 0xA3,
        ],
    },
];
...
impl DirectoryAuthority {
    ...
    pub fn descriptor_url(&self, fingerprint: &str) -> String {
        format!(
            "http://{}:{}/tor/server/fp/{}",
            self.address, self.dir_port, fingerprint
        )
    }
}
