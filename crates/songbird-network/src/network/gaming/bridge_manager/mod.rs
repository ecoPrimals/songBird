...
pub use core::{// Configuration types
    // RealBridgeConfig, // Moved to real_bridge_manager.rs
    NatTraversalInfo, // Session and connection management
    RealBridgeSession, // Status and management
    RealBridgeStatus, BridgeSockets, HolePunchStatus, PacketStats, ProtocolBridgeConfig, RealBridgeManager, RealBridgeMetrics, RealHostInfo, RealPlayerInfo, SessionManagementConfig, SocketConfig};
...
pub use zero_cost_core::{
    ProductionBridgeManager, ZeroCostRealBridgeManager,
...
/// ```
pub mod bridge_manager_module {
    //! Zero-cost bridge manager implementations
}
