...
async fn test_register_plugin() -> SongbirdResult<()> {
    ...
    let plugin_id =
        result.ok_or_else(|| SongbirdError::configuration("Failed to register".to_string()))?;
...
async fn test_register_duplicate_plugin_fails() -> SongbirdResult<()> {
    ...
    registry
        ...
        .await
        .map_err(|e| SongbirdError::configuration("Failed to register".to_string()))?;
...
async fn test_get_plugin() -> SongbirdResult<()> {
    ...
    let retrieved_plugin =
        retrieved.ok_or_else(|| SongbirdError::configuration("Failed to register".to_string()))?;
...
async fn test_unregister_order_matters() -> SongbirdResult<()> {
    ...
    registry
        .unregister(&PluginId::new("middle".to_string()))
        .await
        .map_err(|e| SongbirdError::configuration("Failed to register".to_string()))?;
    registry
        .unregister(&PluginId::new("base".to_string()))
        .await
        .map_err(|e| SongbirdError::configuration("Failed to register".to_string()))?;
...
async fn test_plugin_version_tracking() -> SongbirdResult<()> {
    ...
    let retrieved = registry
        .get(&PluginId::new("test".to_string()))
        .await
        .map_err(|e| SongbirdError::configuration("Failed to register".to_string()))?;
...
async fn test_register_after_unregister() -> SongbirdResult<()> {
    ...
    registry
        ...
        .map_err(|e| SongbirdError::configuration("Failed to register".to_string()))?;
    registry
        .unregister(&PluginId::new("test".to_string()))
        .await
        .map_err(|e| SongbirdError::configuration("Failed to register".to_string()))?;
