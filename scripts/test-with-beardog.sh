#!/usr/bin/env bash
# test-with-beardog.sh — Run the full Songbird test suite with a live BearDog primal.
#
...
#
# Usage:
#   ./scripts/test-with-beardog.sh              # Full test suite
#   ./scripts/test-with-beardog.sh -- -p crate  # Pass extra args to cargo test
#
# Environment:
#   BEARDOG_BIN  — explicit path to beardog binary (skips discovery)
