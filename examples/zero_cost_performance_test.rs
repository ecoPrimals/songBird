...
impl TraditionalService for TraditionalSecurityService {
    ...
    fn process(&self, data: &str) -> String { format!("Traditional security: {}", data) }
}
...
fn main() {
    ...
    let percentage_faster = ((traditional_nanos - zero_cost_nanos) as f64 / traditional_nanos as f64) * 100.0;
